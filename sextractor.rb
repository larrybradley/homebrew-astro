...
class Sextractor < Formula
  ...
  # these patches collectively make the changes needed to compile with
  # the Accelerate framework for linear algebra routines.
  patch do
  ...
  patch do
    # change name/arguments of LAPACK functions from ATLAS to
    # Accelerate, and add include file
